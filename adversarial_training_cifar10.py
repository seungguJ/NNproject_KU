...
k = 7
alpha = 0.00784
file_name = 'resnet18_pgd_adversarial_training'
...
train_dataset = torchvision.datasets.CIFAR10(root='/workspace/my_data', train=True, download=False, transform=transform_train)
...
def test(epoch):
    ...
    if not os.path.isdir('checkpoint'):
        os.mkdir('checkpoint')
    torch.save(state, '/workspace/checkpoint/' + file_name)
    print('Model Saved!')
